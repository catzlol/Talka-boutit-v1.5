  ...
  <body>
    <div id="body">
      <div id="box" style="width:100%;">
        ...
        <hr>
<div id="settingsInfo">
  <h6 id="settingsUpperThird">Manage Keys</h6>
  <a href="/mykeys" style="text-decoration: none; color: blue;">Your Keys</a>
</div>
        <hr>
<div id="settingsInfo">
  <h6 id="settingsUpperThird">View Infractions</h6>
  <a href="/infractions" style="text-decoration: none; color: blue;">View Your Infractions</a>
</div>
